...
| Sample | Description |
|------|--------|
| 1-go-api-idtokenhint | Go sample for using the VC Request API to issue and verify verifiable credentials with a credential contract which allows the VC Request API to pass in a payload for the Verifiable Credentials|
